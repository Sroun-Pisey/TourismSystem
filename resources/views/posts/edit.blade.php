                                    ...
                                    <div class="row"><!-- 2st Row Start -->
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select name="customer_id" id="customer_id" class="form-select" required>
                                                    ...
                                                    @foreach($customers as $customer)
                                                        <option value="{{ $customer->id }}" {{ $post->customer_id == $customer->id ? 'selected' : '' }}>
                                                            {{ $customer->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <div class="form-group">
                                                <div class="controls">
                                                   <img id="showImage" src="{{ !empty($post->feather_image) ? asset('storage/' . $post->feather_image) : asset('img/no_image.jpg') }}"style="width: 100px; height: 100px; border: 1px solid #000000;">
                                                </div>
                                            </div>
                                        </div><!-- End Col-md-4 -->
